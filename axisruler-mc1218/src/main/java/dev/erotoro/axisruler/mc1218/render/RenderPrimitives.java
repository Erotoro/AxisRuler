...
public final class RenderPrimitives {
    ...
    public static void drawBlockOutline(
        ...
        drawOutline(matrices, consumers, FULL_BLOCK_SHAPE, pos.getX(), pos.getY(), pos.getZ(), color);
    }
    ...
    public static void drawShapeOutline(
        ...
        drawOutline(matrices, consumers, shape, offsetX, offsetY, offsetZ, color);
    }
    ...
    private static void drawOutline(
        ...
        VertexRendering.drawOutline(matrices, consumer, shape, offsetX, offsetY, offsetZ, color);
    }
