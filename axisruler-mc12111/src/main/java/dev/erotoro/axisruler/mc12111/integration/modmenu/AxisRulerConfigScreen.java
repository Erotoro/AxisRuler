...
import dev.erotoro.axisruler.mc12111.AxisRulerClient;
...
public final class AxisRulerConfigScreen extends Screen {
    ...
    private void buildHudTab(int x, int y, int width, int height) {
        ...
        addControl(cycleButton(grid.controlX(), grid.rowY(2), grid.controlWidth(), Text.translatable(state.hudAnchor.translationKey()), "axisruler.config.option.hud_anchor.desc", () -> {
    ...
    private void buildLabelsTab(int x, int y, int width, int height) {
        ...
        addControl(cycleButton(grid.controlX(), grid.rowY(1), grid.controlWidth(), Text.translatable(state.labelBackgroundMode.translationKey()), "axisruler.config.option.label_background.desc", () -> {
